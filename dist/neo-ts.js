...
var NeoPromise = (function () {
    ...
    NeoPromise.reject = function (reason) {
        return new NeoPromise(function (_resolve, reject) { return reject(reason); });
    };
    ...
    NeoPromise.resolve = function (value) {
        if (value instanceof NeoPromise)
            return value;
        return new NeoPromise(function (resolve, _reject) { return resolve(value); });
    };
