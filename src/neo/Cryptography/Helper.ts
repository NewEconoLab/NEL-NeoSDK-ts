...
namespace Neo.Cryptography {
    ...
    if (window.crypto.getRandomValues == null) {
        if (w.msCrypto) {
            ...
            window.crypto.getRandomValues = RandomNumberGenerator.getRandomValues as <T extends Uint8Array | Int8Array | Uint8ClampedArray | Int16Array | Uint16Array | Uint32Array | Float32Array | Float64Array | DataView | Int32Array>(array: T) => T;
        }
    }
