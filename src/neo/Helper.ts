...
{
    if (this.Length != 39) { return false; }
    if (this[0] != ThinNeo.OpCode.PUSHBYTES33
        || this[34] != ThinNeo.OpCode.SYSCALL) { return false;}
        //|| this. != BitConverter.ToUInt32(Neo.Cryptography.Sha256.computeHash(ThinNeo.Helper.String2Bytes("Neo.Crypto.CheckMultiSig")) { return false; }
    return true;
}
void function ()
{
